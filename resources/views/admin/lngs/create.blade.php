...
@section('content')
    <div class="row x_panel">
        {{ Form::open(['route'=>['admin.lngs.store'],'enctype'=>'multipart/form-data', 'method' => 'post','class'=>'form-horizontal form-label-left']) }}
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="form-group">
                ...
                <input accept="image/*" type="file" name="icon" class="col-md-7 col-xs-12 @error('icon') parsley-error @enderror">
            </div>
        </div>
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input id="default" type="checkbox" class="col-md-7 col-xs-12"
                           name="default">
                    @error('default')
                    <ul class="parsley-errors-list filled">
                        {{ $message }}
