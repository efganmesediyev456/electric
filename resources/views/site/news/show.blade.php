...
@section('content')
    ...
    <section class="mb-60">
        ...
        <div class="container">
            ...
            <div class="item-nav">
                @if($prevAdvert)
                <a href="{{ route('home.news_detail',[$prevAdvert->lng->short_name, $prevAdvert->name]) }}" class="item-prev">
                ...
                @endif
                    ...
                    @if($nextAdvert)
                    <a href="{{ route('home.news_detail',[$nextAdvert->lng->short_name, $nextAdvert->name]) }}" class="item-next">
