...
<?php $__env->startSection('content'); ?>
    <div class="row x_panel">
        ...
        <?php echo e(Form::open(['route'=>['admin.news.update',$newses[0]->u_id],'enctype'=>'multipart/form-data', 'method' => 'put','class'=>'form-horizontal form-label-left'])); ?>
        ...
        <?php $__currentLoopData = $newses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $news): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="row lng-form" id="<?php echo e($news->lng->u_id); ?>" <?php if(!$news->lng->default): ?> style="display: none" <?php endif; ?>>
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                <select id="cats" name="categories[]" class="select2" multiple="multiple" style="width: 100%" autocomplete="off">
                    <?php $__currentLoopData = $options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option <?php if($newses[0]->categories()->select()->where('u_id', $option->u_id)->first()): ?> selected <?php endif; ?> value="<?php echo e($option->u_id); ?>"><?php echo e($option->title); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\electric\resources\views/admin/news/edit.blade.php ENDPATH**/ ?>