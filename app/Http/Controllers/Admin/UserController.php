...
{   
    ...
    public function store(Request $request)
    {
        ...
        $status = $user->save();
        if($status){
            return redirect()->route('admin.users')->withFlashSuccess('Istifadeci elave olundu');
        } else return redirect()->route('admin.users')->withFlashDanger('Istifadeci elave olundu');
    }
